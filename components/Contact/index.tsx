  ...
  .then((response) => {
    ...
    return (
        <div id="contact">
            ...
            <div className='md:flex justify-center bg-zinc-100    '>
                <form className='py-10 px-2 md:px-0 md:pr-20  border-r border-white'>
                ...
                <div
                    ...
                    className="  border-b border-portfolio-blue  h-fit pb-20  text-portfolio-blue"
                >
                    ...
                    <p className="font-light text-sm mt-2">7347298215</p>
                    <h1 className="font-medium mt-4 md:mt-8">Email:</h1>
                    <p className="font-light text-sm mt-2">nishantxchandel@gmail.com</p>
